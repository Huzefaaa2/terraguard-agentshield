...
The current MVP evaluates protected branch push decisions locally. Future releases will integrate deeper with GitHub/GitLab branch protection and PR checks.
